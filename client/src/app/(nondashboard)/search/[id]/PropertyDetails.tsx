  ...
  return (
    <div className="mb-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 mg:grid-cols-3 lg:grid-cols-4 gap-8">
      ...
      {/* Highlights */}
      <div>
        <h2 className="text-xl font-semibold my-3">Highlights</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 mg:grid-cols-3 lg:grid-cols-4 gap-8">
      ...
      {/* Tabs */}
      <div>
        <h3 className="text-xl font-semibold text-primary-700 dark:text-primary-100 mb-5">
          Fees and Policies
        </h3>
